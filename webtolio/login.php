<?php
session_start();
$pass='webtolio'; // Пароль для входа в Админку
...
<br><br><br><p><a href="http://bakulin-egor.com" target="_blank">Видео инструкция по админке тут —  просто нажмите по этому тексту.</a><br><br>
		<p>Есть вопросы? Нужно что бы изминения внес я? <p>Тогда <a href="http://bakulin-egor.com" target="_blank">вот мой сайт — bakulin-egor.com просто нажмите по этому тексту.</a> <p>Так же, можете написать мне на почту artstrangers@gmail.com</div>');
};
